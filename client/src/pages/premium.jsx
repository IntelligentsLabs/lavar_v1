...
const PremiumFeaturesPage = ({setIsPremium}) => {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 p-6">
      <div className="max-w-2xl bg-white p-8 rounded-xl shadow-lg text-center">
        ...
        <p className="text-gray-700 mb-8">
          Welcome to the premium features section! As a premium user, you have access to exclusive content and features that enhance your experience.
        </p>
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-2">Exclusive Premium Features:</h2>
        ...
        <Button
          ...
          className="text-primary-500 border-primary-500 rounded-3xl text-lg border-2 w-36 align-center"
        >
          Go Back
        </Button>
      </div>
